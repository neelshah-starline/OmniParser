...
📢 [[Project Page](https://microsoft.github.io/OmniParser/)] [[V2 Blog Post](https://www.microsoft.com/en-us/research/articles/omniparser-v2-turning-any-llm-into-a-computer-use-agent/)] [[Models V2](https://huggingface.co/microsoft/OmniParser-v2.0)] [[Models V1.5](https://huggingface.co/microsoft/OmniParser)] [[HuggingFace Space Demo](https://huggingface.co/spaces/microsoft/OmniParser-v2)] [[Changelog](CHANGELOG.md)]
...
- [2025/3] **Fixed**: Resolved Florence-2 model processing errors that were causing "'NoneType' object has no attribute 'shape'" during icon caption generation. All test images now process successfully.
